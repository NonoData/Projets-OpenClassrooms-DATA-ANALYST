...
* **Le problème à résoudre :** 
  ...
  * Le **taux de conversion est divisé par 2** en moins d'un an, passant d'environ 11 % en avril 2019 à 5 % en février 2020.
* **Constats & Facteurs explicatifs :**
  * **Évolution de la mixité produit :** La catégorie *High-tech* (à forte valeur/panier élevé, qui représentait ~50 % du CA au départ) s'effondre au profit de la catégorie *Nourriture* (à panier plus faible), tandis que les *Biens de consommation* restent stables (~33 % du CA).
  * **Engagement client :** Le comportement d'achat individuel ne s'est pas dégardé (la relation positive entre temps passé et panier moyen reste forte, et la médiane du temps passé par acheteur reste stable entre 6 et 7 minutes). C'est la structure du trafic globale et le catalogue qui ont évolué.
* **Les objectifs clés :**
...
* **Nature des données :** 
  ...
  * Données comportementales de web analytics (temps passé sur le site par session, taux de conversion des visiteurs).
